...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className={`z-10 px-6 transition-all duration-1000 ${
        isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
      }`}>
        {/* Layout: Image Left, Content Right */}
        <div className="flex flex-col lg:flex-row items-center gap-12 max-w-6xl mx-auto">
          {/* Profile Image - Left Side */}
          <div className="relative group lg:w-1/3 flex-shrink-0">
            ...
            <div className="relative w-64 h-64 lg:w-80 lg:h-80 rounded-full border-4 border-white dark:border-gray-800 overflow-hidden shadow-2xl transform hover:scale-105 transition-all duration-500">
              <img
                src="/nitin (1).jpg"
                alt="Nitin Kumar"
          ...
          <div className="lg:w-2/3 space-y-8 text-center lg:text-left">
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent animate-gradient-x">
                  NITIN KUMAR
                </h1>
              </div>
        </div>
